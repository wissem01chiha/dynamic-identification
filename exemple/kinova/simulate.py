...
from utils import RobotData, plotArray, plot2Arrays, yaml2dict, RMSE, computeMovingAverage
...
plot2Arrays(computeMovingAverage(0.001*np.transpose(states[7:14,:]),20),qp[:30000:50,:],'state','true',\
    'Joints Velocity State Model Simulation')
plot2Arrays(computeMovingAverage(np.transpose(states[0:7,:]),20),q[0:30000:50,:],'state','true',\
